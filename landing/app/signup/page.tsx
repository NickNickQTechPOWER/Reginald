    ...
    <>
      ...
      <div className="page">
        ...
        <div className="card">
          ...
          <p className="card-sub">Free. No credit card required.</p>
          <form onSubmit={submit}>
            ...
            <button type="submit" className="btn" disabled={loading}>{loading ? 'Creating account…' : 'Get early access'}</button>
          </form>
          <p className="footer-link">Already have an account? <Link href="/login">Sign in</Link></p>
        </div>
      </div>
    </>
  );
